...
from tasks.cs import binary_addition as binary_addition
from tasks.cs import binary_multiplication as binary_multiplication
from tasks.cs import bucket_sort as bucket_sort
from tasks.cs import compute_sqrt as compute_sqrt
from tasks.cs import duplicate_string as duplicate_string
#from tasks.cs import missing_duplicate_string
from tasks.cs import interlocked_pairing as interlocked_pairing
from tasks.cs import odds_first as odds_first

from tasks.ndcf import divide_by_two as divide_by_two
#from tasks.dcf import modular_arithmetic_brackets
from tasks.dcf import reverse_string as reverse_string
#from tasks.dcf import solve_equation
from tasks.dcf import stack_manipulation as stack_manipulation
from tasks.dcf import compare_occurrence as compare_occurrence

from tasks.regular import cycle_navigation as cycle_navigation
from tasks.regular import even_pairs as even_pairs
from tasks.regular import Old_modular_arithmetic as modular_arithmetic
from tasks.regular import parity_check as parity_check
from training import curriculum as curriculum_lib

from tasks.regular import Old_modular_arithmetic as modular_arithmetic_cl
