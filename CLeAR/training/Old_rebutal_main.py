...
from neural_networks_chomsky_hierarchy.training import Old_reg_tasks_training as training
from neural_networks_chomsky_hierarchy.training import Old_tasks_utils as utils
...
def main(arg_dict={'developing':True}) -> None:
    ...
    if use_raw:
        from neural_networks_chomsky_hierarchy.training import Old_constants_raw as constants
    else:
        from neural_networks_chomsky_hierarchy.training import Old_constants_mapped as constants
    ...
    def my_cl_loss_fn(output, additional, target, idx, par2=par2):
        ...
        if cl_setting[1] == 'lwf': # CL using previous task model
