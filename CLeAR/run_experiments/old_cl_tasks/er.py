...
dict_ = {}
dict_['univ_setting'] = 0 # This indicates it is basic scenario // Not used for old scenario yet
os.environ["CUDA_VISIBLE_DEVICES"]= '0'


dict_['sheet_name'] = 'none'
memory_size_list = [1_000, 3_000, 10_000,]
task_name = 'er'
...
joint_list = [False]
architecture = ['rnn', 'stack_rnn', 'tape_rnn', 'lstm',] #['tape_rnn','stack_rnn','lstm', 'rnn']
step_list = [50_000]
dict_['fa_dim']=4
    ...
    for idx, tasks in enumerate(tasks_list):
        ...
        for method in dim_match_method_list:
            ...
            for joint in joint_list:
                ...
                if joint: dict_['cl_setting'] = (False,False,1)
                else: dict_['cl_setting'] = cl_setting
